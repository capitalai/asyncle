...
struct command {
    ...
    template <class P>
    using result_t = std::conditional_t<accepts<P>, asyncle::compat::expected<payload_t<P>, error_type>, void>;
};
...
struct default_make_command {
    ...
    using result_t = std::conditional_t<
      accepts<P>,
      std::conditional_t<std::same_as<error_type, void>, payload_t<P>, asyncle::compat::expected<payload_t<P>, error_type>>,
      void>;
};
